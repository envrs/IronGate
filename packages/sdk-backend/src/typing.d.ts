declare module "irongate:plugin" {
  ...
  export type MetaSDK = {
    /**
     * The directory of the plugin in Irongate Data.
     * You can store data related to your plugin in this directory.
     */
    path(): string;
    /**
     * The directory of the plugin's assets in Irongate Data.
    ...
    assetsPath(): string;
    /**
     * Get a sqlite database for the plugin stored in Irongate Data.
     ...
     *
     * @throws If Irongate Cloud is offline.
     */
